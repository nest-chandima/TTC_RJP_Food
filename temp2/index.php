...
<body class="abc">
    <div class="container-fluid overflow-x-hidden" id="main">
        <div class="row">
            <div class="col-12" style="margin-top:12px; margin-bottom: 40px;">
                <div class="row">
                    <div class="col-12 position-relative">
                        <div class="row">
                            <div class="col-12 position-relative" style="z-index: 5;">
                                <div class="row">
                                    <p class="text-center" style="font-weight: 900; font-size: 8vw; color: white; margin-top: 17vw;">
                                    昼食検索　ごはんちゃん
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="row">
                            <p class="text-center fs-3" style="font-weight: 700;">東中野のおすすめランチ</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    $product_rs = Database::search("SELECT * FROM `gohann`");
                                    ...
                                    $selected_rs = Database::search("SELECT * FROM `gohann` LIMIT " . $products_per_page . " OFFSET " . $page_results . "");
                                    ...
                                    ?>
                                        <div class="col-lg-3 col-12 mb-3 mb-sm-0 mb-lg-3 mb-0 d-flex align-items-stretch food-card">
                                            <a href="<?php echo "https://www.google.com/maps/search/".$product_data["name"]."東中野"; ?>" target="_blank" style="text-decoration:none;">
                                            <div class="card flex-grow-1" style="border-radius: 1vw;background-color: #D9D9D9;">
                                                ...
                                                <div class="card-body " style="margin-top:240px">
                                                    <h2 class="card-title text-center fs-4" style="font-weight: 600; font-size:30px;"><?php echo $product_data["name"]; ?></h2>
                                                    <div class="col-12" >
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="row">
                                                                    <p class="fs-5" style="font-weight: 600;"><span><?php if($product_data["price_min"]!=0){echo "￥".$product_data["price_min"];} ?></span>～<span><?php echo "￥". $product_data["price_max"]; ?></span></p>
                                                                </div>
                                                            </div>
                            ...
                            <div class="col-12 mt-lg-5 mt-3">
                                <div class="row">
                                    <p class="text-center fs-6 mt-4">***写真にはAIで作成したイラストも含まれています。</p>
                                </div>
                            </div>
                        </div>
                    </div>
